...
def read_playlist():
	...
	playlist_description = input("Enter playlist name: ") + "\n"
...
def add_video(playlist):
	...
	new_video_title = input("Enter new video tilte: ") + "\n"
...
def update_playlist(playlist):
	print("Which elements of playlist do you want to update?")
	print("1. Name")
	print("2. Description")
	print("3. Rating")

	choice = select_in_range("Enter the element you want to update (1-3): ",1, 3)
	if choice == 1:
		new_playlist_name = input("Enter the new name of playlist: ") + "\n"
		playlist.name = new_playlist_name
		print("Updated successfully!")
		return playlist
	if choice == 2:
		new_playlist_description = input("Enter the new description of playlist: ") + "\n"
		playlist.description = new_playlist_description
		print("Updated successfully!")
		return playlist
	if choice == 3:
		new_playlist_rating = str(select_in_range("Enter the new rating of playlist (1-5): ", 1, 5)) + "\n"
...
def main():
	...
	while True:
		...
		if choice == 1:
			...
			print("Add new video successfully!")
			input("\nPress Enter to continue.\n")
		elif choice == 5:
